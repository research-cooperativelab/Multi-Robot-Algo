...
The ablation shows that the bid function is the dominant factor,
centralization contributing essentially nothing once the bid is
probability-aware. This result concretely answers the question
implicitly raised by \citet{OtteKuhlman2020} of whether coordination
structure or bid design is the more impactful design decision under
