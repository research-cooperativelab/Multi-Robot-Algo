...
\paragraph{The idea.} To recover the energy lost under the single-sortie
constraint of Model 3, each robot is permitted to chain several sites
into one flight before returning to base. The auction still runs at base to pick each robot's \emph{first}
